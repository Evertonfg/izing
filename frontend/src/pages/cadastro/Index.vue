        ...
        >
          ...
          <q-card-section class="text-primary text-center">
            <q-img
              ...
              spinner-color="white"
              style="height: 30px; max-width: 130px"
          ...
          <q-card-section class="text-primary">
            ...
            <div class="text-caption text-grey">Cadastre sua empresa...</div>
          </q-card-section>
          ...
          <q-card-section>
            <q-input
              ...
              error-message="Deve ser um e-mail valído."
              outlined
  ...
  methods: {
    fazerLogin () {
      ...
      if (this.$v.form.$error) {
        this.$q.notify('Informe os dados para cadastro.')
        return
      }
      this.loading = true
      this.$store.dispatch('CadastroLogin', this.form)
        .then(data => {
